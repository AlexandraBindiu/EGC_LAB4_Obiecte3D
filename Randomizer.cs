...
namespace Obiecte3D
{
    class Randomizer
    {
        ...
        private const int HIGHT_COORD_VAL = -25;
        ...
        {
            int genA = r.Next(LOW_COORD_VAL, HIGHT_COORD_VAL);
            int genB = r.Next(LOW_COORD_VAL, HIGHT_COORD_VAL);
            int genC = r.Next(LOW_COORD_VAL, HIGHT_COORD_VAL);
